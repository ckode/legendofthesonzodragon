...
weapons_list = [
    Weapon(id=1, weight=5, min_damage=0, max_damage=3, buy_value=0, sell_value=0, monster_only=False,
           name="small club",
           description="This is a small rough-hewn tree limb to function as a club."),

    Weapon(id=2, weight=5, min_damage=0, max_damage=3, buy_value=0, sell_value=0, monster_only=False,
           name="small dagger",
           description="This is a small utility dagger that can be used for self-defense if required."),

    Weapon(id=3, weight=10, min_damage=1, max_damage=4, buy_value=10, sell_value=5, monster_only=False,
           name="rapier",
           description="This rapier is primarily a thrust weapon with a vary sharp point."),

    Weapon(id=4,weight=12, min_damage=1, max_damage=5, buy_value=12, sell_value=6, monster_only=False,
           name="cutlass",
           description="This cutlass is short sabre style slashing sword with a slight upward curved blade with "
                       "a basket shared guard."),
    Weapon(id=5, weight=15, min_damage=3, max_damage=8, buy_value=20, sell_value=10, monster_only=False,
