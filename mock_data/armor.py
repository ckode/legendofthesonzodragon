...
armor_list = [
    Armor(id=1, ac=2, weight=5, damage_buffer=0, buy_value=0, sell_value=0, monster_only=False,
          name="cloth rags",
          description="These are cloth rags stitched together as general body coverings and provide very"
                      "little protection.", image_url="../../../static/images/items/armor_cloth_rags.png"),
    Armor(id=2, ac=5, weight=10, damage_buffer=0, buy_value=30, sell_value=5, monster_only=False,
          ...
          image_url="../../../static/images/items/armor_leather_patch_armor.png"),
    Armor(id=3, ac=20, weight=15, damage_buffer=2, buy_value=100, sell_value=30, monster_only=False,
          name="leather armor",
          ...
          image_url="../../../static/images/items/armor_leather_armor.png"  ),
    Armor(id=4, ac=25, weight=50, damage_buffer=5, buy_value=150, sell_value=50, monster_only=False,
          ...
          image_url="../../../static/images/items/armor_basic_chainmail.png"  ),
    Armor(id=5, ac=25, weight= 70, damage_buffer=8, buy_value=500, sell_value=250, monster_only=False,
          ...
          image_url="../../../static/images/items/armor_dragon_scale.png"  )
]